    ...
    <div class="card shadow mb-4 w-50" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-6">
            <div class="d-sm-flex align-items-center justify-content-end">
              <a href="../layouts/download.php" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
      ...
      <div class="collapse show" id="generate">
        <div class="card-body">
          ...
          <hr class="bg-danger">
          <h6 class="mb-3"><span class="text-danger font-weight-bold">Laporan :</span> <?= $row['isi_laporan']; ?></h6>
          ...
          <div class="row">
            ...
            <div class="col-4">
              <div class="d-flex justify-content-end">
                <a href="generate.php" class="btn btn-outline-danger">Kembali</a>
              </div>
            </div>
          </div>
        </div>
