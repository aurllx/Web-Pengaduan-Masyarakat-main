...
<div class="row py-5">
  <div class="col-6 py-5 mt-3">
    ...
    <h2 class="text-gray-800" data-aos="fade-down">Selamat datang, di website pengaduan masyarakat</h2>
      ...
      <a href="buatLaporan.php" class="btn btn-danger shadow" data-aos="fade-up">Buat Laporan</a>
      <a href="lihatLaporan.php" class="btn btn-outline-danger ml-2" data-aos="fade-up" data-aos-duration="500">Lihat Laporan</a>
    </div>
  </div>
  <div class="col-6">
    <div class="image" data-aos="fade-left">
      <img src="../../assets/img/dbu.svg" width="450" alt="">
    </div>
  </div>
</div>
