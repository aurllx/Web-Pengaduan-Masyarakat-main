          ...
          <div class="row">
            ...
            <div class="col-6">
              <div class="d-sm-flex align-items-center justify-content-end">
                <a onclick="ga('send', 'event', 'Getting started', 'Download', 'Aduan Masyarakat');" href="../layouts/down.php" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
